...
public interface IQuestionService
{
    ...
    Task PlayPersonDetectionPromptAsync(CallConnection callConnection, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>Task representing the async operation</returns>
    Task PlayHealthcareQuestionAsync(CallConnection callConnection, int questionNumber, CancellationToken cancellationToken = default);
    ...
    Task<bool> HandleInvalidDtmfAsync(CallConnection callConnection, int questionNumber, int retryCount, CancellationToken cancellationToken = default);
    ...
    Task<bool> HandleTimeoutAsync(CallConnection callConnection, int questionNumber, bool hasRetriedOnce, CancellationToken cancellationToken = default);
